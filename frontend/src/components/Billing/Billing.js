...
useEffect(() => {
  ...
  const paymentHandler = async(e) =>{
    ...
    const response = await fetch('https://harsh-project-6.onrender.com/order',{
      method: "POST",
      body: JSON.stringify({
        amount,
        currency,
    ...
    var options = {
      ...
      "handler": async function(response){
        ...
        const validateRes = await fetch('https://harsh-project-6.onrender.com/order/validate',{
          method: "POST",
        ...
        {
          try{
            const response = await fetch(`https://harsh-project-6.onrender.com/bills/billforcart/${user.user?._id}`, {
              method: "POST",
                ...
                <div key={item._id} className="cItem1 cItem11">
                  <div className="cItem cItemm">
                    <div className="cItemImg cItemImgg">
                      <img src={`https://harsh-project-6.onrender.com/uploads/${item.productDetails?.product?.productImages[0]}`} alt={item.productDetails?.product?.title} />
                    </div>
