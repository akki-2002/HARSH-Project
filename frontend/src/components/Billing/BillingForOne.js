...
//   }
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch(`https://harsh-project-6.onrender.com/bills/billforone/${user.user?._id}/${id}`, {
        method: "POST",
                ...
                <div key={cartItems._id} className="cItem1 cItem11">
                  <div className="cItem cItemm">
                    <div className="cItemImg cItemImgg">
                      <img src={`https://harsh-project-6.onrender.com/uploads/${cartItems.product?.productImages[0]}`} alt={cartItems.product?.title} />
                    </div>
